...
Through our analysis, we found that the most common type of power plants across several different countries was `r summary_info$energy_source_with_most_number_of_power_plants `, while the most used energy source was . Our second chart revealed that was the largest emitter of co2 into the atmosphere, and that the median co2 emissions for countries excluding the US, China, India, Russia was . Lastly, we found that the country with the highest nuclear power usage was while the country with the highest nuclear ratio was . 
